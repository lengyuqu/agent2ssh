...
> 检查日期：2026-06-22（测试计数于 2026-07-11 更新）
> 项目版本：0.2.1
...
| Rust 库单元测试 | ✅ 通过 | **255 / 255** 全部通过（230 `#[test]` + 25 `#[tokio::test]`） |
| CLI Smoke 测试 | ✅ 通过 | **29 / 29** 全部通过（6 `#[test]` + 23 `#[tokio::test]`） |
| Daemon 集成测试 | ✅ 通过 | **57 / 57** 全部通过（14 `#[test]` + 43 `#[tokio::test]`） |
