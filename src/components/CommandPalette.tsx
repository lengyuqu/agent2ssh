...
const MCP_TOOLS: { name: string; moduleId: string }[] = [
  ...
  { name: "ssh_sftp_rename", moduleId: "files-sessions" },
  { name: "ssh_sftp_rm", moduleId: "files-sessions" },
  { name: "ssh_sftp_rmdir", moduleId: "files-sessions" },
  { name: "ssh_sftp_rm_rf", moduleId: "files-sessions" },
